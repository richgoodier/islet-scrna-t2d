...
Figures are in [`analysis/`](analysis/) and [`presentation/`](presentation/).
...
├── references/             # Source paper and supplementary materials
├── presentation/           # Final presentation slides and figures
├── submission/             # Course submission files
├── writeup/                # Individual course writeup
...
3. [`analysis/volcano.ipynb`](analysis/volcano.ipynb) — differential expression
4. [`analysis/analysis_1.ipynb`](analysis/analysis_1.ipynb) — t-SNE, PCA, logistic regression

## Citation

Segerstolpe Å, et al. *Single-Cell Transcriptome Profiling of Human Pancreatic Islets in Health and Type 2 Diabetes.* Cell Metabolism. 2016;24(4):593-607. doi:10.1016/j.cmet.2016.08.020

## Acknowledgments

This project was developed collaboratively by Group 3 for BINF 6310. Team member names are listed in [`submission/`](submission/) and will be credited here upon permission.
